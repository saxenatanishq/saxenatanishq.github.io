        ...
        <footer class="bg-gray-800 text-white py-6 text-center mt-auto">
            <div class="max-w-7xl mx-auto px-6">
                ...
                <p class="text-sm mt-2">
                    Source code available on <a href="https://github.com/saxenatanishq/personal-webpage" target="_blank" class="text-indigo-400 hover:underline">GitHub</a>.  Contact me: <a href="mailto:tanishqsaxena.in@gmail.com" class="text-indigo-400 hover:underline">tanishqsaxena.in@gmail.com</a> 
                </p>
            </div>
        </footer>
    )
